...
import AnnotationsSection from '../../../../components/features/knowledge/annotations/AnnotationsSection';
  ...
  useEffect(() => {
    async function fetchAnnotatedDocuments() {
      ...
      try {
        ...
        const response = await fetch(`http://localhost:8000/api/knowledge/annotated_documents`, {
          headers: { 'Authorization': `Bearer ${session.access_token}` }
        });
