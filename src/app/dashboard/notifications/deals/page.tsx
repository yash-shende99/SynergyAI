...
export default function DealUpdatesPage() {
  ...
  const handleMarkAsRead = async (notificationId: string) => {
    // Optimistically update UI for a snappy experience
    ...
    try {
      ...
      fetchNotifications(); // Revert UI on failure
    }
  };
    ...
    <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p className="text-secondary">Notifications related to project status changes and new documents.</p>
            </div>
        </div>
        <NotificationFeed 
