  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { section: "terms", label: "Terms & Conditions" },
    ...
    <footer className="bg-background border-t border-border pt-16 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              AI-powered M&A intelligence platform helping investment professionals make smarter, faster decisions.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-synergy-ai-primary transition-colors">
                ...
                {section.links.map((link) => (
                  <li key={link.section}>
                    <button
                      ...
                      className="text-gray-400 hover:text-synergy-ai-primary transition-colors text-left"
                    >
                      {link.label}
                    </button>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-border text-center text-gray-500 text-sm">
          ...
          <p className="mt-1">
            Transforming M&A intelligence with artificial intelligence.
          </p>
        </div>
      </div>
    </footer>
