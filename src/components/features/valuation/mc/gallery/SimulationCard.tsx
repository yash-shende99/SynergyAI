...
const SimulationCard: FC<SimulationCardProps> = ({ simulation, projectId, onDelete, onDuplicate }) => {
  return (
    <div className="rounded-2xl border border-border bg-surface/50 p-6 flex flex-col group">
      ...
      <div className="mt-4 pt-4 border-t border-border/50 flex justify-between items-center">
        <Link href={`/dashboard/project/${projectId}/valuation/mc/${simulation.id}`} className="text-sm font-semibold text-primary hover:underline">
          Open Simulation
        </Link>
